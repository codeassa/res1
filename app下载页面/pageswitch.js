(function($){
	...
	SP.moveSectionDown = function(){
		if(iIndex<(arrElement.length-1)){
			iIndex++;
			$(".line").stop().animate({"left":"0px"},1000);
			$(".second").stop().animate({"margin-right":"250px"},1000);
			if(iIndex>1){
				$(".line3").stop().animate({"left":"0px"},1000);
				$(".third").stop().animate({"margin-right":"250px"},1000);
				console.log(iIndex);
					if(iIndex>2){
					$(".line4").stop().animate({"left":"0px"},1000);
					$(".four").stop().animate({"margin-right":"250px"},1000);
					console.log(iIndex);
						if(iIndex>3){
						$(".line5").stop().animate({"left":"0px"},1000);
						$(".five").stop().animate({"margin-right":"250px"},1000);
						console.log(iIndex);
						}
					}
			}
